...
\institute[LONI HPC Workshop, Xavier University of Louisiana - New Orleans] {\inst{}\footnotesize{User Services Consultant\\LSU HPC \& LONI\\sys-help@loni.org}}

\date[{Mar 21, 2012\hspace{2cm}}]{\scriptsize{LONI HPC Workshop\\Xavier University of Louisiana\\New Orleans\\Mar 21, 2012}}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{enumerate}
      ...
      \item X-Server (if needed): X-ming \url{http://www.straightrunning.com/XmingNotes/}
      }
    \end{enumerate}
  \end{itemize}
\end{frame}
